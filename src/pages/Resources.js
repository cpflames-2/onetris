export default function Resources() {
  return (
    <div className="App" style={{ textAlign: 'left', margin: '20px' }}>
      ...
      <br/> <small>Good chess lessons with bots and people to play, in a kid-friendly environment</small>
      <br/>
      ...
      <br/> <small>Great for preschoolers to learn how the pieces move, and how to checkmate!</small>
      <br/>
      ▶ <a href="https://play.google.com/store/apps/details?id=com.universis.dinosaurchess">Dinosaur Chess</a>
      <br/> <small>Fun chess lessons with Scottish dinosaurs</small>
